...
import com.example.hotelbookingsystem.utils.BookingUtils;
...
public class HotelBookingService {
    ...
    private boolean checkAvailable(String checkin, String checkout,
								   List<Date> checkinList, List<Date> checkoutList) throws ParseException {
    ...
    public void sendMail(String to, String subject, String body)
    {
        ...
        message.setFrom("lynnelin2021@yahoo.com");
        message.setTo(to);
